...
export const login: AsyncThunk<User, LoginState, ThunkAPIType> =
  createAsyncThunk(LOGIN_ACTION_PREFIX, async (data: LoginState, thunkAPI) => {
    if (lastLoginRequest) {
...
export const signup: AsyncThunk<User, SignupState, ThunkAPIType> =
  createAsyncThunk(
